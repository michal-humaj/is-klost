...
// @DATE:Mon Mar 09 21:53:20 CET 2015
...
// @LINE:9
private[this] lazy val controllers_Events_edit5_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("event/"),DynamicPart("eventType", """[^/]+""",true),StaticPart("/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Events_edit5_invoker = createInvoker(
...
// @LINE:10
private[this] lazy val controllers_Events_update6_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("event/"),DynamicPart("eventType", """[^/]+""",true),StaticPart("/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Events_update6_invoker = createInvoker(
...
// @LINE:11
private[this] lazy val controllers_Events_drag7_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/event/"),DynamicPart("eventType", """[^/]+""",true),StaticPart("/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Events_drag7_invoker = createInvoker(
...
// @LINE:13
private[this] lazy val controllers_Events_editStrmn8_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("event/"),DynamicPart("eventType", """[^/]+""",true),StaticPart("/"),DynamicPart("id", """[^/]+""",true),StaticPart("/storeman"))))
...
// @LINE:14
private[this] lazy val controllers_Events_updateStrmn9_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("event/"),DynamicPart("eventType", """[^/]+""",true),StaticPart("/"),DynamicPart("id", """[^/]+""",true),StaticPart("/storeman"))))
...
// @LINE:15
private[this] lazy val controllers_Events_editInstl10_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("event/INSTALLATION/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Events_editInstl10_invoker = createInvoker(
...
// @LINE:16
private[this] lazy val controllers_Events_updateInstl11_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("event/INSTALLATION/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Events_updateInstl11_invoker = createInvoker(
...
// @LINE:17
private[this] lazy val controllers_Events_changeCal12_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/event/"),DynamicPart("eventType", """[^/]+""",true),StaticPart("/"),DynamicPart("id", """[^/]+""",true),StaticPart("/changeCal"))))
private[this] lazy val controllers_Events_changeCal12_invoker = createInvoker(
...
// @LINE:18
private[this] lazy val controllers_Events_delete13_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("event/"),DynamicPart("eventType", """[^/]+""",true),StaticPart("/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Events_delete13_invoker = createInvoker(
...
// @LINE:19
private[this] lazy val controllers_Events_upcomingActions14_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/actions/upcoming"))))
private[this] lazy val controllers_Events_upcomingActions14_invoker = createInvoker(
...
// @LINE:23
private[this] lazy val controllers_Items_list15_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/items"))))
private[this] lazy val controllers_Items_list15_invoker = createInvoker(
...
// @LINE:24
private[this] lazy val controllers_Items_listTentItems16_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/listTentItems"))))
private[this] lazy val controllers_Items_listTentItems16_invoker = createInvoker(
...
// @LINE:25
private[this] lazy val controllers_Items_listEventItems17_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/listEventItems"))))
private[this] lazy val controllers_Items_listEventItems17_invoker = createInvoker(
...
// @LINE:26
private[this] lazy val controllers_Items_add18_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/item"))))
private[this] lazy val controllers_Items_add18_invoker = createInvoker(
controllers.Items.add(),
HandlerDef(this.getClass.getClassLoader, "", "controllers.Items", "add", Nil,"POST", """""", Routes.prefix + """ajax/item"""))
        

// @LINE:27
private[this] lazy val controllers_Items_update19_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/item/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Items_update19_invoker = createInvoker(
...
// @LINE:28
private[this] lazy val controllers_Items_delete20_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/item/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Items_delete20_invoker = createInvoker(
...
// @LINE:32
private[this] lazy val controllers_Avail_availability21_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/avail"))))
private[this] lazy val controllers_Avail_availability21_invoker = createInvoker(
...
// @LINE:36
private[this] lazy val controllers_Tents_list22_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tents"))))
private[this] lazy val controllers_Tents_list22_invoker = createInvoker(
...
// @LINE:37
private[this] lazy val controllers_Tents_neu23_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tent"))))
private[this] lazy val controllers_Tents_neu23_invoker = createInvoker(
controllers.Tents.neu(),
HandlerDef(this.getClass.getClassLoader, "", "controllers.Tents", "neu", Nil,"GET", """""", Routes.prefix + """tent"""))
        

// @LINE:38
private[this] lazy val controllers_Tents_add24_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tent"))))
private[this] lazy val controllers_Tents_add24_invoker = createInvoker(
controllers.Tents.add(),
HandlerDef(this.getClass.getClassLoader, "", "controllers.Tents", "add", Nil,"POST", """""", Routes.prefix + """tent"""))
        

// @LINE:39
private[this] lazy val controllers_Tents_edit25_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tent/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Tents_edit25_invoker = createInvoker(
...
// @LINE:40
private[this] lazy val controllers_Tents_update26_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tent/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Tents_update26_invoker = createInvoker(
...
// @LINE:41
private[this] lazy val controllers_Tents_delete27_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tent/"),DynamicPart("id", """[^/]+""",true),StaticPart("/delete"))))
private[this] lazy val controllers_Tents_delete27_invoker = createInvoker(
...
// @LINE:42
private[this] lazy val controllers_Tents_getTent28_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ajax/tent/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Tents_getTent28_invoker = createInvoker(
...
// @LINE:46
private[this] lazy val controllers_Documents_priceOffer29_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("priceOffer/"),DynamicPart("eventType", """[^/]+""",true),StaticPart("/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Documents_priceOffer29_invoker = createInvoker(
...
// @LINE:47
private[this] lazy val controllers_Documents_contract30_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("contract/"),DynamicPart("eventType", """[^/]+""",true),StaticPart("/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_Documents_contract30_invoker = createInvoker(
...
// @LINE:50
private[this] lazy val controllers_App_login31_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("login"))))
private[this] lazy val controllers_App_login31_invoker = createInvoker(
...
// @LINE:53
private[this] lazy val controllers_App_oAuthDenied34_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("authenticate/"),DynamicPart("provider", """[^/]+""",true),StaticPart("/denied"))))
private[this] lazy val controllers_App_oAuthDenied34_invoker = createInvoker(
...
// @LINE:57
private[this] lazy val controllers_App_jsRoutes35_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("assets/javascripts/routes"))))
private[this] lazy val controllers_App_jsRoutes35_invoker = createInvoker(
...
// @LINE:59
private[this] lazy val controllers_App_jsMessages37_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("jsmessages"))))
private[this] lazy val controllers_App_jsMessages37_invoker = createInvoker(
...
// @LINE:9
case controllers_Events_edit5_route(params) => {
   call(params.fromPath[String]("eventType", None), params.fromPath[String]("id", None)) { (eventType, id) =>
        controllers_Events_edit5_invoker.call(controllers.Events.edit(eventType, id))
   }
}
        

// @LINE:10
case controllers_Events_update6_route(params) => {
   call(params.fromPath[String]("eventType", None), params.fromPath[String]("id", None)) { (eventType, id) =>
        controllers_Events_update6_invoker.call(controllers.Events.update(eventType, id))
   }
}
        

// @LINE:11
case controllers_Events_drag7_route(params) => {
   call(params.fromPath[String]("eventType", None), params.fromPath[String]("id", None)) { (eventType, id) =>
        controllers_Events_drag7_invoker.call(controllers.Events.drag(eventType, id))
   }
}
...
// @LINE:15
case controllers_Events_editInstl10_route(params) => {
   call(params.fromQuery[String]("eventType", None), params.fromPath[String]("id", None)) { (eventType, id) =>
        controllers_Events_editInstl10_invoker.call(controllers.Events.editInstl(eventType, id))
   }
}
        

// @LINE:16
case controllers_Events_updateInstl11_route(params) => {
   call(params.fromQuery[String]("eventType", None), params.fromPath[String]("id", None)) { (eventType, id) =>
        controllers_Events_updateInstl11_invoker.call(controllers.Events.updateInstl(eventType, id))
   }
}
        

// @LINE:17
case controllers_Events_changeCal12_route(params) => {
   call(params.fromPath[String]("eventType", None), params.fromPath[String]("id", None)) { (eventType, id) =>
        controllers_Events_changeCal12_invoker.call(controllers.Events.changeCal(eventType, id))
   }
}
        

// @LINE:18
case controllers_Events_delete13_route(params) => {
   call(params.fromPath[String]("eventType", None), params.fromPath[String]("id", None)) { (eventType, id) =>
        controllers_Events_delete13_invoker.call(controllers.Events.delete(eventType, id))
   }
}
        

// @LINE:19
case controllers_Events_upcomingActions14_route(params) => {
   call { 
        controllers_Events_upcomingActions14_invoker.call(controllers.Events.upcomingActions())
   }
}
        

// @LINE:23
case controllers_Items_list15_route(params) => {
   call { 
        controllers_Items_list15_invoker.call(controllers.Items.list())
   }
}
        

// @LINE:24
case controllers_Items_listTentItems16_route(params) => {
   call { 
        controllers_Items_listTentItems16_invoker.call(controllers.Items.listTentItems())
   }
}
        

// @LINE:25
case controllers_Items_listEventItems17_route(params) => {
   call { 
        controllers_Items_listEventItems17_invoker.call(controllers.Items.listEventItems())
   }
}
        

// @LINE:26
case controllers_Items_add18_route(params) => {
   call { 
        controllers_Items_add18_invoker.call(controllers.Items.add())
   }
}
        

// @LINE:27
case controllers_Items_update19_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Items_update19_invoker.call(controllers.Items.update(id))
   }
}
        

// @LINE:28
case controllers_Items_delete20_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Items_delete20_invoker.call(controllers.Items.delete(id))
   }
}
        

// @LINE:32
case controllers_Avail_availability21_route(params) => {
   call { 
        controllers_Avail_availability21_invoker.call(controllers.Avail.availability())
   }
}
        

// @LINE:36
case controllers_Tents_list22_route(params) => {
   call { 
        controllers_Tents_list22_invoker.call(controllers.Tents.list())
   }
}
        

// @LINE:37
case controllers_Tents_neu23_route(params) => {
   call { 
        controllers_Tents_neu23_invoker.call(controllers.Tents.neu())
   }
}
        

// @LINE:38
case controllers_Tents_add24_route(params) => {
   call { 
        controllers_Tents_add24_invoker.call(controllers.Tents.add())
   }
}
        

// @LINE:39
case controllers_Tents_edit25_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Tents_edit25_invoker.call(controllers.Tents.edit(id))
   }
}
        

// @LINE:40
case controllers_Tents_update26_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Tents_update26_invoker.call(controllers.Tents.update(id))
   }
}
        

// @LINE:41
case controllers_Tents_delete27_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Tents_delete27_invoker.call(controllers.Tents.delete(id))
   }
}
        

// @LINE:42
case controllers_Tents_getTent28_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Tents_getTent28_invoker.call(controllers.Tents.getTent(id))
   }
}
        

// @LINE:46
case controllers_Documents_priceOffer29_route(params) => {
   call(params.fromPath[String]("eventType", None), params.fromPath[String]("id", None)) { (eventType, id) =>
        controllers_Documents_priceOffer29_invoker.call(controllers.Documents.priceOffer(eventType, id))
   }
}
        

// @LINE:47
case controllers_Documents_contract30_route(params) => {
   call(params.fromPath[String]("eventType", None), params.fromPath[String]("id", None)) { (eventType, id) =>
        controllers_Documents_contract30_invoker.call(controllers.Documents.contract(eventType, id))
   }
}
        

// @LINE:50
case controllers_App_login31_route(params) => {
   call { 
        controllers_App_login31_invoker.call(controllers.App.login())
   }
}
...
// @LINE:53
case controllers_App_oAuthDenied34_route(params) => {
   call(params.fromPath[String]("provider", None)) { (provider) =>
        controllers_App_oAuthDenied34_invoker.call(controllers.App.oAuthDenied(provider))
   }
}
        

// @LINE:57
case controllers_App_jsRoutes35_route(params) => {
   call { 
        controllers_App_jsRoutes35_invoker.call(controllers.App.jsRoutes())
   }
}
...
// @LINE:59
case controllers_App_jsMessages37_route(params) => {
   call { 
        controllers_App_jsMessages37_invoker.call(controllers.App.jsMessages())
   }
}
        

// @LINE:61
case controllers_App_calendar38_route(params) => {
   call(params.fromPath[String]("date", None)) { (date) =>
        controllers_App_calendar38_invoker.call(controllers.App.calendar(date))
   }
}
