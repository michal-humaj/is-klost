...
/**/
object modalExport extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {

  /**/
  def apply():play.twirl.api.HtmlFormat.Appendable = {
      _display_ {

Seq[Any](format.raw/*1.1*/("""<div class="modal fade" id="modalExportItem" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group" data-bind="attr: """),format.raw/*15.62*/("""{"""),format.raw/*15.63*/(""" """),format.raw/*15.64*/("""class: importAmount.isValid() ? 'form-group' : 'form-group has-info' """),format.raw/*15.133*/("""}"""),format.raw/*15.134*/("""">
                        <label class="col-sm-2 control-label no-padding-right">"""),_display_(/*16.81*/Messages("lbl.export")),format.raw/*16.103*/("""</label>
                        <div class="col-sm-3 controls">
                            <div class="input-group">
                                <input id="inputExportAmount" class="form-control" placeholder="4" data-bind="value: importAmount().value">
                ...
                <div class="modal-footer">
                    <div class="pull-left">
                        <button type="button" class="btn btn-primary" data-bind="click: exprt">"""),_display_(/*31.97*/Messages("btn.export")),format.raw/*31.119*/("""</button>
...
"""))}
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Fri Mar 13 20:24:31 CET 2015
