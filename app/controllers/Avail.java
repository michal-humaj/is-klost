...
public class Avail extends Controller {
    ...
    public static Result listEventsAt(String date) throws IOException {
        LocalDate localDate = new LocalDate(date);
        EventsContainer container = getEventsContainerForDate(localDate);
    ...
    public static Result availability() {
        ...
        ArrayList<AvailTO> availTos = getAvailListForEvents(container);
        return ok(toJson(availTos));
    }

    public static ArrayList<AvailTO> getAvailListForEvents(EventsContainer container){
    ...
    public static EventsContainer getEventsContainerForDate(LocalDate localDate) throws IOException {
